...
export default function DeleteTask({ isOpen, onClose, onDelete, taskId }: DeleteTaskModalProps) {
  return (
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      ...
                      <span className="font-semibold">{taskId}</span>? This action cannot be undone.
                    </p>
                  </div>
                </div>
              </div>
